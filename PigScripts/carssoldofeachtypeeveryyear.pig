...
dataGroup = group data by (year,VClass);
dataCount = foreach dataGroup generate group, COUNT(data.VClass);
Store dataCount into 'hdfs://localhost:9000/pig_output/carssoldofeachtypeeveryyear' using PigStorage(',');
